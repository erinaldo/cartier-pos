...
namespace ETL
{
    namespace BLL
    {
        public class CCustomerBO
        {
            ...
            public CResult Create(CCustomer oCS)
            {
                oResult = new CResult();
            ...
            public CResult ReadAll(CCustomer oCS)
            {
            ...
            public CResult ReadByID(CCustomer oCS)
            {
                oResult = new CResult();
                conn = oConnManager.GetConnection(out s_DBError);
                if (conn != null)
            ...
            public CResult Import(CCustomer oCS)
            {
                oResult = new CResult();
                conn = oConnManager.GetConnection(out s_DBError);
                if (conn != null)
