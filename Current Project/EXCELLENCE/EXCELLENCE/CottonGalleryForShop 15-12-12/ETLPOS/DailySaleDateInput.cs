...
namespace ETLPOS
{
    public partial class DailySaleDateInput : BaseForm
    {
        public DailySaleDateInput()
        {
            InitializeComponent();
        ...
        private void DailySaleDateInput_Load(object sender, EventArgs e)
        {
            LoadExportedBranch();
            LoadReportBranch();
            LoadReportBranch2();
        ...
        private void ShowReport()
        {
            ...
            oListCReturnItem = oCSOBO.ReadSalesReturn(dtpDate.Value.Date);
